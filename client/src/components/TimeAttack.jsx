      ...
      <div className='timeAttackBG'>
          ...
          <div className='answersAndModelContainer'>
              <div className='modelContainer'>
                <Unicorn/>
                {hintText === "" ? undefined : <div className="bubble bubble-bottom-left" contenteditable>{hintText}</div>}
              </div>
              <div className='answerOptionsContainer'>
                <div className={gameStarted === false ? 'answerOptionDeactive' : 'answerOption'} onClick={gameStarted === true ? () => {handleClick("A")} : undefined} style={ifAnswerButtonPressed === "A" ? {filter: `hue-rotate(${answerIsOk}deg)`} : {undefined} }><span>{randomQuestion.A}</span></div>
                <div className={gameStarted === false ? 'answerOptionDeactive' : 'answerOption'} onClick={gameStarted === true ? () => {handleClick("B")} : undefined} style={ifAnswerButtonPressed === "B" ? {filter: `hue-rotate(${answerIsOk}deg)`} : {undefined} }><span>{randomQuestion.B}</span></div>
                <div className={gameStarted === false ? 'answerOptionDeactive' : 'answerOption'} onClick={gameStarted === true ? () => {handleClick("C")} : undefined} style={ifAnswerButtonPressed === "C" ? {filter: `hue-rotate(${answerIsOk}deg)`} : {undefined} }><span>{randomQuestion.C}</span></div>
                <div className={gameStarted === false ? 'answerOptionDeactive' : 'answerOption'} onClick={gameStarted === true ? () => {handleClick("D")} : undefined} style={ifAnswerButtonPressed === "D" ? {filter: `hue-rotate(${answerIsOk}deg)`} : {undefined} }><span>{randomQuestion.D}</span></div>
              </div>
          </div>
      </div>      
      : (isFirstGame === false)?    
